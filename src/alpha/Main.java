      ...
      @Override public void handle(long l) {
        ...
        switch (data.getSoundEffect()){
          case PhantomDestroyed:
            new MediaPlayer(new Media(getHostServices().getDocumentBase()+"src/sound/ballon_explose.mp3")).play();
            break;
          case HeroesGotHit:
            new MediaPlayer(new Media(getHostServices().getDocumentBase()+"src/sound/chercher_piece.mp3")).play();
            break;
          default:
            break;
        }
