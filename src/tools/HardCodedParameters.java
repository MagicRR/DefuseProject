...
public class HardCodedParameters {
  ...
  public static final int defaultMinWidth = 0, defaultMinHeight = 0, defaultWidth = 800, defaultHeight = 600,
                          heroesStartX = 80, heroesStartY = 200, heroesWidth=60, heroesHeight=90, heroesStep = 10,
                          phantomWidth = 30, phantomHeight = 30, phantomStep = 10, objectWidth = 30, objectHeight = 30, objectStep = 10;
